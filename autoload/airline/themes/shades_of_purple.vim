...
let s:normal1 = [ "#A599E9", "#2A2041", 140, 234 ]
let s:normal2 = [ "#2A2041", "#A599E9", 234, 140 ]
...
let s:insert1 = [ "#D5A6F8", "#2A2041", 159, 234 ]
let s:insert2 = [ "#2A2041", "#A599E9", 234, 140 ]
let s:insert3 = [ "#D5A6F8", "#2A2041", 159, 234 ]
let g:airline#themes#shades_of_purple#palette.insert = airline#themes#generate_color_map(s:insert1, s:insert2, s:insert3)

let s:replace1 = [ "#2A2041", "#FF628C", 234, 204 ]
let s:replace2 = [ "#2A2041", "#ff91ae", 234, 211 ]
let s:replace3 = [ "#A599E9", "#2A2041", 140, 234 ]
let g:airline#themes#shades_of_purple#palette.replace = airline#themes#generate_color_map(s:replace1, s:replace2, s:replace3)

let s:visual1 = [ "#2A2041", "#c991ff", 234, 177 ]
let s:visual2 = [ "#2A2041", "#FB94FF", 234, 213 ]
let s:visual3 = [ "#A599E9", "#2A2041", 140, 234 ]
let g:airline#themes#shades_of_purple#palette.visual = airline#themes#generate_color_map(s:visual1, s:visual2, s:visual3)

let s:inactive1 = [ "#A599E9", "#2A2041", 140, 234 ]
let s:inactive2 = [ "#A599E9", "#2A2041", 140, 234 ]
let s:inactive3 = [ "#A599E9", "#2A2041", 140, 234 ]
...
let s:CP1 = [ "#A599E9", "#2A2041", 140, 234 ]
let s:CP2 = [ "#2A2041", "#A599E9", 234, 140 ]
let s:CP3 = [ "#A599E9", "#2A2041", 140, 234 ]
